...
if number_of_transmit_antenna >= 2 && number_of_receive_antenna >=2
    ostbc_encoder = comm.OSTBCEncoder('NumTransmitAntennas', 2);
    ostbc_combiner = comm.OSTBCCombiner('NumTransmitAntennas', 2, ...
                                        'NumReceiveAntennas', number_of_receive_antenna);
end
...
number_of_bits_per_frame = (((number_of_resource_block * number_of_data_subcarrier * number_of_symbol_per_subcarrier * number_of_bits_per_symbol * number_of_transmit_antenna) ...
                            / number_of_transmit_antenna)* coding_rate) - crc_bit; %% Initializing number of bits per frame
